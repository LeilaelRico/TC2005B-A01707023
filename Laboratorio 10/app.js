...
-       response.write('<div class="row d-flex justify-content-center"><div class="col-md-6"><article class="blog-post"><h2 class="blog-post-title fst-italic">Vivencia</h2> <p>La verdad es, que hasta el día de hoy soy una persona que no había atravesado muchos cambios hasta hace más o menos, dos años y medio, un evento hizo que me replanteara todas las cosas que hasta la fecha tenía y también la forma en la que pensaba.<br>Actualmente, sigo caracterizándome por ser proactivo en las cosas que son de mi interés así como en situaciones de presión,además, soy leal, respetuoso, responsable y siento una mayor confianza cuando puedo expresarme de manera escrita.</p><hr></div></div>');
        ...
        response.write('<div class="text-center">Foals es una banda originaria de Oxford, Inglaterra. La banda publica con Transgressive Records en Europa y Sub Pop en los EE. UU. Publicaron un álbum completo—titulado Antidotes—el 24 de marzo de 2008 en el Reino Unido, y el 8 de abril en EE. UU. Iba a ser producido originalmente por Dave Sitek de TV on the Radio pero la banda rechazó la mezcla final de Sitek y remezclaron el disco entero ellos mismos debido al excesivo uso del efecto reverb que le daba un sonido espacial.<br>Fuente: https://es.wikipedia.org/wiki/Foals<hr></div>');
        response.write(`<div class="text-center"><h4>Everything Everything</h4></div>`);
        response.write('<div class="text-center">Everything Everything es un grupo inglés de indie rock, creado a finales de 2007. Sus integrantes son de Newcastle, Kent y Guernsey. La banda saltó a la fama cuando se dieron a conocer en el programa “Sound of 2010”, de la BBC el 7 de diciembre de 2009. Debutaron con el álbum “Man Alive” gracias Geffen Records el 30 de agosto de 2010, donde se colocaron en el número 17 en Reino Unido.<br>Fuente: https://es.wikipedia.org/wiki/Everything_Everything<hr></div>');
        response.write('<div class="text-center"><a href="/">Regresar al inicio</a></div>');
        response.write('</body>');
        response.end();
